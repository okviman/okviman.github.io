...
- [Multi-Marginal Flow Matching with Adversarially Learnt Interpolants](https://arxiv.org/abs/2510.01159), *ICLR 2026* (with Kirill Tamogashev, Nicola Branchini, Víctor Elvira, Jens Lagergren and Nikolay Malkin)
...
### Theses
- [Variational Mixtures and Multi-Marginal Flow Matching: Advancing Statistical Inference with Biological Applications](okviman.github.io/thesis.html), *Ph.D. Thesis 2026* (opponent: [Ben Raphael](https://engineering.princeton.edu/faculty/ben-raphael); supervised by [Jens Lagergren](https://lagergrenlab.org/))
